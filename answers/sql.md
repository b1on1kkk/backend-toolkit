...
## <a name="sharding_&_replication"></a>Шардирование, Секционирования и Репликация

**Шардирование** — разделение хранилища на несколько независимых частей, шардов (от англ. shard — осколок).

**Секционирование** — разделение таблицы на несколько частей меньшего размера.

**Репликация** - На каждом инстансе находятся одинаковые данные (копии).
