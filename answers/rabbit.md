...
**Headers exchange** — направляет сообщения в связанные очереди на основе свойства headers (ключ, значение) привязки и аналогичного свойства сообщения.

![fanout_exchange](../pictures/headers_exchange.jpeg)

Особенности:

- гибкость.

- дополнительные накладные расходы на вычисление. Все пары (ключ, значение) атрибута **headers** должны сортироваться по имени ключа перед вычислениями. **Медленнее, чем прочие типы exchange.**
